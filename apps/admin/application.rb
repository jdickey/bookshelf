...
module Admin
  # NOTE: Prevent RuboCop from complaining about generated code.
  # rubocop:disable Style/WordArray, Style/PercentLiteralDelimiters
  class Application < Hanami::Application
    ...
    # rubocop:enable Style/WordArray, Style/PercentLiteralDelimiters
  end
end
